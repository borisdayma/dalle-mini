...
with block:
 ...
 gr.Markdown("DALL·E mini is an AI model that generates images from any prompt you give!")
 prompt = gr.inputs.Textbox(lines = 3,placeholder="An astronaut riding a horse in a photorealistic style")
